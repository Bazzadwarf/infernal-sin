...
#include "PIPlayerAllowAttackChainIncreaseNotifyState.generated.h"

/**
 *
 */
UCLASS()
class PROJECTINFERNO_API UPIPlayerAllowAttackChainIncreaseNotifyState : public UAnimNotifyState
{
    GENERATED_BODY()
public:
    virtual void
