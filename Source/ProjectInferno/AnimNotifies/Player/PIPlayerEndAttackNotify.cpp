...
#include "PIPlayerEndAttackNotify.h"
#include "PIPlayerController.h"
#include "ProjectInfernoPlayerCharacter.h"

void UPIPlayerEndAttackNotify::Notify(USkeletalMeshComponent* mesh_component, UAnimSequenceBase* animation)
{
